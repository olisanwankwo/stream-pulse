    ...
    <div class="library">
      ...
      >
          <div class="inner">
            <div class="banner">
              <div class="title">
                <h3 :class="{ 'dark-mode': darkMode }">{{ showDetails.original_name }}</h3>      
                </div>
                <div class="btn">
    ...
    async fetchShowDetails(id) {
      try {
        const [detailsResponse, creditsResponse] = await Promise.all([
          fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=843e1637e2566935058ea3d9a03a551f&append_to_response=videos`),
          fetch(`https://api.themoviedb.org/3/tv/${id}/credits?api_key=843e1637e2566935058ea3d9a03a551f`)
        ]);
