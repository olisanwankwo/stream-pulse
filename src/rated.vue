<template>
  ...
  <div class="library">
    ...
    <ul>
      ...
      <div class="carousel">
        <h3><i  :class="{ 'dark-mode': darkMode }"></i> Top Rated</h3 >
        ...
        <div class="carousels">
            <h3><i :class="{ 'dark-mode': darkMode }"></i> Best of Shows</h3 >
...
export default {
  ...
  methods: {
    async fetchMovieData() {
      try {
        const response = await fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=843e1637e2566935058ea3d9a03a551f');
