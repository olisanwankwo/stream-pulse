<template>
    <div class="preloader-overlay" v-show="!isPageLoaded">
      ...
      <div class="navbar" :class="{ 'dark-mode': darkMode }">
        ...
        <div class="carousel">
          <h3><i  :class="{ 'dark-mode': darkMode }"></i> Top Animation</h3 >
          ...
          <div class="carousels">
              <h3><i :class="{ 'dark-mode': darkMode }"></i> Best of Animation</h3 >
  ...
  export default {
    ...
    methods: {
      async fetchMovieData() {
        try {
          const response = await fetch('https://api.themoviedb.org/3/discover/movie?api_key=843e1637e2566935058ea3d9a03a551f&with_genres=16');
